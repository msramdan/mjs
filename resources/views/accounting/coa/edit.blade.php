            ...
            <div class="col-md-6">
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <form action="{{ route('akun-coa.update', $akunCoa->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('kode') is-invalid @enderror" type="text" id="kode"
                                    ...
                                    value="{{ old('kode') ? old('kode') : $akunCoa->kode }}" autofocus />
                                @error('kode')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('nama') is-invalid @enderror" type="text" id="nama"
                                    ...
                                    value="{{ old('nama') ? old('nama') : $akunCoa->nama }}" />
                                @error('nama')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('normal') is-invalid @enderror" type="text" id="normal"
                                    name="normal" placeholder="Normal"
                                    value="{{ old('normal') ? old('kode') : $akunCoa->kode }}" />
                                @error('normal')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('remark') is-invalid @enderror" type="text" id="remark"
                                    ...
                                    value="{{ old('remark') ? old('remark') : $akunCoa->remark }}" />
                                @error('remark')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <select class="form-select @error('account_header_id') is-invalid @enderror"
                                    ...
                                    @foreach ($akunHeader as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('account_header_id') && old('account_header_id') == $item->id ? 'selected' : '' }}
                                            {{ $akunCoa->account_header_id == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama }}
                                        </option>
                                    @endforeach
