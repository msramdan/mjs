    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
                ...
                <td colspan="4">
                    <table>
                        <tr>
                            ...
                            <td>
                                <strong>#{{ $invoice->kode }}</strong><br />
                                <strong>{{ $invoice->tanggal_invoice->format('d F Y') }}</strong><br />
                ...
                <td colspan="4">
                    <table>
                        <tr>
                            ...
                            <td>
                                {{ $invoice->sale->spal->customer->nama }}<br />
                                {{ $invoice->sale->spal->customer->email }}<br />
                                {{ $invoice->sale->spal->customer->telp }}<br />
                                {{ $invoice->sale->spal->customer->alamat }}
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr class="item">
                ...
                <td>Rp. {{ number_format($invoice->sale->diskon, 0, ',', '.') }}</td>
            </tr>
            ...
            <tr class="item">
                ...
                <td><strong>Rp. {{ number_format($invoice->sale->grand_total, 0, ',', '.') }} </strong></td>
            </tr>
        </table>
