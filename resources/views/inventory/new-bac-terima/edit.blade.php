...
@section('title', 'Edit New BAC Terima')

@section('content')
    <div id="content" class="app-content">

        {{ Breadcrumbs::render('new_bac_terima_edit') }}

        <form action="{{ route('new-bac-terima.update', $bac->id) }}" method="POST" id="form-bac"
    ...
    <script>
        ...
        $('#form-bac').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: '{{ route('new-bac-terima.update', $bac->id) }}',
                headers: {
        ...
        $('#kode, #tanggal, #keterangan, #produk, #qty-terima, #nama, #file').on('change keyup', function() {
            cekForm()
            // cekTableLength()
        })
