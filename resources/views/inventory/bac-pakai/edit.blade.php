...
@section('title', 'Edit BAC Pakai')

@section('content')
    <div id="content" class="app-content">

        {{ Breadcrumbs::render('bac_pakai_edit') }}

        <form action="{{ route('bac-pakai.update', $bacPakai->id) }}" method="POST" id="form-bac"
    ...
    <script>
        ...
        $('#form-bac').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: '{{ route('bac-pakai.update', $bacPakai->id) }}',
                headers: {
