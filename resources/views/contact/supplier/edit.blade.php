                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('kode') is-invalid @enderror" type="text" id="kode"
                                    ...
                                    value="{{ old('kode') ? old('kode') : $supplier->kode }}" required autofocus />
                                @error('kode')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('nama') is-invalid @enderror" type="text" id="nama"
                                    ...
                                    value="{{ old('nama') ? old('nama') : $supplier->nama }}" required />
                                @error('nama')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('catatan') is-invalid @enderror" id="catatan"
                                    ...
                                    required>{{ old('catatan') ? old('catatan') : $supplier->catatan }}</textarea>
                                @error('catatan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('email') is-invalid @enderror" type="email" id="email"
                                    ...
                                    value="{{ old('email') ? old('email') : $supplier->email }}" required />
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('provinsi') is-invalid @enderror" type="text"
                                    ...
                                    value="{{ old('provinsi') ? old('provinsi') : $supplier->provinsi }}" required />
                                @error('provinsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('telp') is-invalid @enderror" type="telp" id="telp"
                                    ...
                                    value="{{ old('telp') ? old('telp') : $supplier->telp }}" required />
                                @error('telp')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('personal_kontak') is-invalid @enderror" type="text"
                                    ...
                                    value="{{ old('personal_kontak') ? old('personal_kontak') : $supplier->personal_kontak }}" />
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('website') is-invalid @enderror" type="text" id="website"
                                    ...
                                    value="{{ old('website') ? old('website') : $supplier->website }}" />
                                @error('website')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('kode_pos') is-invalid @enderror" type="text"
                                    ...
                                    value=" {{ old('kode_pos') ? old('kode_pos') : $supplier->kode_pos }}" />
                                @error('kode')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
